...
const PLANNED_TARGETS = {
  ...
  // A9 cross-cutting
  ChecklistAssignmentWizard: "src/domains/work/ (Phase B) / cross-cutting A9",
  ReviewLine: "cross-cutting A9",
  ChecklistAssignmentView: "cross-cutting A9",
  AssignmentViewer: "cross-cutting A9",
  AssignmentTabContent: "cross-cutting A9",
  SuggestedTabContent: "cross-cutting A9",
  NextUpModal: "cross-cutting A9",
  SwitchBedroomModal: "cross-cutting A9",
  ReassignModal: "cross-cutting A9",
  ReviewAssignmentModal: "cross-cutting A9",
  RequestNewItemModal: "cross-cutting A9",
  BlockedNoteModal: "cross-cutting A9",
  SheetQuickViewModal: "cross-cutting A9",
  SpanishTranslationPanel: "cross-cutting A9",
  TranslationOverridesModal: "cross-cutting A9",
  WelcomeModal: "cross-cutting A9",
