...
export function BlockedNoteModal({ target, onSave, onClose, busy }) {
      ...
      <div className="bg-stone-50 w-full sm:max-w-md sm:rounded-3xl rounded-t-3xl flex flex-col">
        ...
        <div className="p-5">
          <div className="mb-3 p-3 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 text-xs flex gap-2">
            ...
            <span>
              Heads up — marking this blocked{" "}
              <b>closes the entire assignment</b> for this bedroom and sends it
              to your manager. Only use this when you can't finish the work
              (e.g. tenant home, no access).
            </span>
          </div>
          <textarea
            value={note}
            ...
            rows={4}
            placeholder="e.g. Tenant home, couldn't get in. Need new key."
