...
export function CleanerMenuSheet({
  employee,
  shift,
  onClose,
  onSwitchProperty,
      ...
      <div className="relative bg-stone-50 w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="px-5 py-4 border-b border-stone-200 bg-white">
          ...
          {shift?.customer && (
            <div className="mt-2 pt-2 border-t border-stone-100 text-xs text-stone-600 flex items-center gap-1.5">
              ...
              Clocked in at:{" "}
              <span className="font-medium">{shift.customer.name}</span>
            </div>
          )}
        </div>
        ...
        <div className="bg-white">
          {onAttachProperty && (
            <Item
              icon={Building2}
              label="Pick a property"
              hint="Keep your time running, just attach a property to this shift"
          ...
          {onSwitchProperty && (
            <Item
              ...
              hint="Clock out here and clock in somewhere else"
          ...
          <Item
            icon={LogOut}
            label="Sign out"
            hint="You'll need your PIN to sign back in"
            danger
            onClick={onSignOut}
          />
        </div>
