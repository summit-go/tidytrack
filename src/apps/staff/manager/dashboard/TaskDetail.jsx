...
import { PhotoColumn } from "../dashboard/PhotoColumn.jsx";

export function TaskDetail({ task, compact, employee }) {
  ...
  return (
    <div
      className={
        compact ? "" : "p-4 rounded-2xl bg-white border border-stone-200"
      }
    >
      <div className="flex items-start justify-between mb-2">
        ...
        {!task.end_time && (
          <span className="px-2 py-0.5 rounded-full bg-amber-100 text-amber-800 text-xs font-mono">
            live
          </span>
        )}
      </div>
