...
import { ApartmentGridBuilder } from "../properties/ApartmentGridBuilder.jsx";
import { TownhomeImportBuilder } from "../properties/TownhomeImportBuilder.jsx";

export function BulkCreateUnits({ property, onCancel, onSaved }) {
    ...
    <div className="min-h-screen bg-stone-50 pb-24">
      ...
      <div className="px-5 pt-4">
        <div className="flex gap-1 mb-4 bg-stone-100 p-1 rounded-xl">
          <button
            onClick={() => setMode("apartment-grid")}
          ...
          <button
            onClick={() => setMode("townhome-import")}
