...
export const BUILD_TAG = "aug6-tap135";
...
export const SUMMIT_LOGO_URL = 'https://bbaynvqnbkjyqhzhhypr.supabase.co/storage/v1/object/public/brand/unnamed%20(2).png';
export const SUMMIT_COMPANY = { name: 'Summit Clean LLC', lines: ['1391 North 380 West', 'Provo, Utah 84604', 'United States'], url: 'www.gosummitclean.com' };
